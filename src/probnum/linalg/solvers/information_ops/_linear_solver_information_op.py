...
class LinearSolverInformationOp(abc.ABC):
    ...
    For a given action, the information operator collects information
    about the linear system to be solved.

    See Also
    --------
    MatVecInformationOp: Collect information via matrix-vector multiplication.
    ProjectedResidualInformationOp: Collect information via a
